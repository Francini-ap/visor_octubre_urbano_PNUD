...
/// Capa de coropletas de % Focus de contaminación  (Desfogues CBIMA)
$.getJSON('https://francini-ap.github.io/datos_actubreurbano2/cultivos_desfogues.geojson', function (geojson) {
  var capa_cantones_gam_coropletas = L.choropleth(geojson, {
	  valueProperty: 'num_desfog',
	  scale: ['#ccccfe','#0505da'],
	  steps: 5,
	  mode: 'q',
	  style: {
	 ...
	 onEachFeature: function popup_registros (feature, layer) {
	layer.bindPopup("<div style=text-align:center><h3>"+feature.properties.distrito+
	  "<h3></div><hr><table><tr><td>Número de desfogues: "+feature.properties.num_desfog.toLocaleString()+
	  "</td></tr><tr><td>Porcentaje desfogues: "+feature.properties.por_desfog +'%'+
...
"</td></tr></table>",
  ...
  control_capas.addOverlay(capa_cantones_gam_coropletas, 'Cantidad desfogues cercanos a los cauces por distrito ');	
...
// Capa de coropletas de % Cultivos(MOCUPP Urbano CBIMA)
$.getJSON('https://francini-ap.github.io/datos_actubreurbano2/cultivos_desfogues.geojson', function (geojson) {
  var capa_cantones_gam_coropletas = L.choropleth(geojson, {
	  valueProperty: 'por_cultiv',
	  scale: ['#fbede5','#d46520'],
	  steps: 5,
	  mode: 'q',
	  style: {
	 ...
	 onEachFeature: function popup_registros (feature, layer) {
	layer.bindPopup("<div style=text-align:center><h3>"+feature.properties.distrito+
	  "<h3></div><hr><table><tr><td>Área de cultivo: "+feature.properties.area_cul_m +'m2'+
	  "</td></tr><tr><td>Porcentaje superficie cultivo: "+feature.properties.por_cultiv+'%'+
...
"</td></tr></table>",
  ...
  control_capas.addOverlay(capa_cantones_gam_coropletas, 'Superficie de las áreas cultivos por distritos  ');	
...
$.getJSON('https://francini-ap.github.io/datos_actubreurbano2/ai2.geojson', function (geojson) {
  var capa_cantones_gam_coropletas = L.choropleth(geojson, {
	...
	layer.bindPopup("<div style=text-align:center><h3>"+feature.properties.distrito+
	  ...
	  "</td></tr><tr><td> Población asentamiento informal: "+feature.properties.poblacion+
	  "</td></tr><tr><td> Trama verde por habitante: "+feature.properties.tv_hab+
...
"</td></tr></table>",
  ...
  control_capas.addOverlay(capa_cantones_gam_coropletas, 'Superficie de trama verde por habitante en los asentamientos informales ');	
